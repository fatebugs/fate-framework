package com.fatebug.base.utils.reflect;

import com.fatebug.base.utils.DateUtils;
import com.fatebug.base.utils.text.Convert;
...
public class ReflectUtils {
     ...
     * @param args           参数 （为空时表示无参数，匹配方法时不区分参数类型） （基本数据类型的参数用其包装类型）
     */
    @SuppressWarnings("unchecked")
                ...
                if (args[i] != null && !args[i].getClass().equals(cs[i])) {
                    if (cs[i] == String.class) {
                        ...
                        if (args[i] instanceof String) {
                            args[i] = DateUtils.stringToDate(String.valueOf(args[i]));
                        } else {
