...
public class IdWorker implements Serializable {
    ...
    @Serial
    private static final long serialVersionUID = -6208625080925321312L;

    // 时间起始标记点，作为基准，一般取系统的最近时间（一旦确定不能变动）
    private final static long twepoch = 1672730304783L;
    // 机器标识位数
    ...
    public synchronized static String nextIdToString() {
