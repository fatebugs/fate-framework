...
public class MyStringRedisTemplate {
     ...
     * value 序列化
     */
    private static final StringRedisSerializer OBJECT_SERIALIZER = new StringRedisSerializer();
    ...
    public MyStringRedisTemplate(RedisTemplate<String, String> redisTemplate) {
        ...
        return redisTemplate.execute((RedisCallback<Map<String, String>>) connection -> {
            ...
            if (!CollectionUtils.isEmpty(keys)) {
                for (String key : keys) {
                    ...
                    String value = OBJECT_SERIALIZER.deserialize(bValues);
                    maps.put(key, value);
                }
            }
            return maps;
    ...
    public void delHashValues(String key, String... hashKeys) {
        opsForHash().delete(key, (Object) hashKeys);
    }
