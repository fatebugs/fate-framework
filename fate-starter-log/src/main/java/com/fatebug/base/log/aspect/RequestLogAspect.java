...
public class RequestLogAspect {
     ...
     */
    @Around(
            "execution(!static com.fatebug.base.core.api.R *(..)) && " +
    ...
    public void logIngArgs(ProceedingJoinPoint point, StringBuilder beforeReqLog, List<Object> beforeReqArgs) {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            if (value instanceof HttpServletRequest) {
                ...
                paraMap.put(name, StringUtils.removeSuffix(sb.toString(), StringPool.COMMA));
                continue;
            ...
            } else if (new Jackson2ObjectMapperBuilder().build().canSerialize(value.getClass())) {
                // 判断模型能被 json 序列化，则添加
                paraMap.put(paraName, value);
            } else {
