...
public class AuthUtil {
    ...
    public static TokenInfo getTokenInfo(String token) {
        return authLogic.getTokenInfo(token);
    }
     ...
     *
     * @param hasRoles 角色权限注解
     */
    public static boolean checkRole(HasRoles hasRoles) {
        return authLogic.checkRole(hasRoles);
    }
    ...
    public static boolean checkRoleOr(String... roles) {
        return authLogic.checkRoleOr(roles);
    }
     ...
     */
    public static boolean checkPermi(HasPermission hasPermission) {
        return authLogic.checkPerm(hasPermission);
    }
     ...
     */
    public static boolean checkPermiAnd(String... permissions) {
        return authLogic.checkPermAnd(permissions);
    }
