 ...
 *
 */
public class FateFeignSentinel {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new FateSentinelInvocationHandler(target, dispatch, new FallbackFactory.Default(fallbackInstance));
					}
					if (void.class != fallbackFactory) {
						...
						return new FateSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					// 默认fallbackFactory
					FateFallbackFactory fateFallbackFactory = new FateFallbackFactory(target);
					return new FateSentinelInvocationHandler(target, dispatch, fateFallbackFactory);
				}
